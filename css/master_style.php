...
*******************/
@import url(<?php echo $base_url;?>assets/vendor_components/font-awesome/css/font-awesome.css);
@import url(<?php echo $base_url;?>assets/vendor_components/Ionicons/css/ionicons.css);
@import url(<?php echo $base_url;?>assets/vendor_components/themify-icons/themify-icons.css);
@import url(<?php echo $base_url;?>assets/vendor_components/linea-icons/linea.css);
@import url(<?php echo $base_url;?>assets/vendor_components/glyphicons/glyphicon.css);
@import url(<?php echo $base_url;?>assets/vendor_components/flag-icon/css/flag-icon.css);
@import url(<?php echo $base_url;?>assets/vendor_components/material-design-iconic-font/css/materialdesignicons.css);
@import url(<?php echo $base_url;?>assets/vendor_components/simple-line-icons-master/css/simple-line-icons.css);
@import url(<?php echo $base_url;?>assets/vendor_components/cryptocoins-master/webfont/cryptocoins.css);
...
.layout-boxed {
    background: url(<?php echo $base_url;?>images/boxed-bg.png) fixed;
}
...
.dash-form select.form-control:not([size]):not([multiple]) {
...
.jq-icon-warning { background-color: #fbae1c; color: #333333; border-color: #df9e1b; }
.jq-icon-error { background-color: #ef5350; color: #f2dede; border-color: #e73f3c; }
...
/*lockscreen*/
.lockscreen {
    background: url(<?php echo $base_url;?>images/login-register.jpg) center center no-repeat #d2d6de;
    background-size: cover;
    height: 100%;
    width: 100%;
    position: fixed;
...
.error-body {
    ...
    text-align: center;
    position: fixed;
    background-image: url(<?php echo $base_url;?>images/bg-e.jpg);
	background-size: cover;
	background-repeat: no-repeat;
}
...
.bg-success-gradient{
background: linear-gradient(270deg, #00c292, #e3fcf2);
background-size: 200% 200%;
}
...
.bg-danger-gradient{
background: linear-gradient(270deg, #f15c30, #fce3e3);
background-size: 200% 200%;
}
